 ...
 * @author Joako0z
 */
public class VentanaConsultaProyecto extends javax.swing.JInternalFrame {
    /**
    ...
    public VentanaConsultaProyecto() {
        //initComponents();
        this.objConn = new MySqlConn();
        String query = "Select * from notaventa";
        Object titulos[] = {"ID de la Nota de Venta", "ID de la Venta","Fecha de la Venta","Fecha de Instalacion"
            ,"Costo de la  Venta","Metros de Instalacion"};
        datos=control(query, 6);
