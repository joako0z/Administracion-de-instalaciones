 ...
 * @author Joako0z
 */
public class VentanaModifcarInstalador extends javax.swing.JInternalFrame {
    ...
    public VentanaModifcarInstalador() {
        initComponents();
        llenaEstados();
    }
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Total de Instalaciones");
...
///
         ...
         query = "update instalador set "
                + "nomInstal='" + this.jTextField1.getText()
                + "', calleInstal='" + this.jTextField2.getText()
                + "', numInstal='" + this.jTextField3.getText()
                + "', colInstal='" + this.idcolonia
                + "', cpInstal='" + this.jTextField4.getText()
                + "', munInstal='" + this.idmunicipio
                + "', estadoInstal='" + this.idestado
                + "', telcelInstal='" + this.jTextField6.getText()
                + "', telInstal='" + this.jTextField5.getText()
                + "', totInstal='" + this.jTextField8.getText() + "' where idInstal="+this.jTextField7.getText();
         System.out.println("QUERY: "+query);
        objConn.Update(query);

        JOptionPane.showMessageDialog(this, "Instalador modificado exitosamente", "Mensaje", 1);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        String query = "Select * from instalador where idInstal="+this.jTextField7.getText();
