 ...
 * @author Joako0z
 */
public class VentanaEliminarInstalador extends javax.swing.JInternalFrame {

    /**
     * Creates new form VentanaNuevoCliente
     */
    MySqlConn objConn = new MySqlConn();
    public VentanaEliminarInstalador() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (opc == 0) {
            ...
            objConn.Update("delete from instalador where idinstal='"+jTextField7.getText()+"'");
                    //baseDeDatos cl = new baseDeDatos();
            //cl.borrar_cliente(this.jTextField13.getText());
            JOptionPane.showMessageDialog(this, "Instalador Borrado exitosamente", "Mensaje", 1);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (texto.equals("")) {
            ...
            String query = "select * from instalador where idinstal='" + texto + "';";
            ...
            try {
                ...
                jTextField1.setText(objConn.rs.getString("nomInstal"));
                jTextField2.setText(objConn.rs.getString("calleInstal"));
                jTextField3.setText(objConn.rs.getString("numInstal"));
                jTextField4.setText(objConn.rs.getString("cpInstal"));
                jTextField5.setText(objConn.rs.getString("telinstal"));
                jTextField6.setText(objConn.rs.getString("telcelinstal"));
                
                int index1=llenaEstados(objConn.rs.getString("estadoinstal"));
