 ...
 * @author Joako0z
 */
public class VentanaConsultaInstalador extends javax.swing.JInternalFrame {
    /**
    ...
    public VentanaConsultaInstalador() {
        //initComponents();
        this.objConn = new MySqlConn();
        String query = "Select * from instalador";
        Object titulos[] = {"ID del Instalador", "Nombre del Instalador","Calle del Instaladore","Numero del Instalador"
                ,"Colonia del Instalador","Codigo Postal del Instalador","Municipio del Instalador","Estado del Instalador"
                ,"Telefono Celular del Instalador","Telefono del Instalador","Total de Instalaciones"};
