...
public class VentanaEliminarCliente extends javax.swing.JInternalFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (opc == 0) {
            ...
            objConn.Update("delete from cliente where idcliente='"+jTextField7.getText()+"'");
                    //baseDeDatos cl = new baseDeDatos();
            //cl.borrar_cliente(this.jTextField13.getText());
            JOptionPane.showMessageDialog(this, "Cliente Borrado exitosamente", "Mensaje", 1);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (texto.equals("")) {
            ...
            String query = "select * from cliente where idcliente='" + texto + "';";
            ...
            try {
                ...
                jTextField1.setText(objConn.rs.getString("nomcliente"));
                jTextField2.setText(objConn.rs.getString("callecliente"));
                jTextField3.setText(objConn.rs.getString("numcliente"));
                jTextField4.setText(objConn.rs.getString("cpcliente"));
                jTextField5.setText(objConn.rs.getString("telcliente"));
                jTextField6.setText(objConn.rs.getString("telcelcliente"));
                
                int index1=llenaEstados(objConn.rs.getString("estadocliente"));
                
                jComboBox1.setSelectedIndex(index1);
                System.out.println("---------"+objConn.rs.getString("fecregcliente"));
                
                
                
                String fecha = new SimpleDateFormat("dd-MM-yyyy").format(objConn.rs.getString("fecregcliente"));
