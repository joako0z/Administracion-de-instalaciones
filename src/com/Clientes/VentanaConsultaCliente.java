 ...
 * @author Joako0z
 */
public class VentanaConsultaCliente extends javax.swing.JInternalFrame {
    /**
    ...
    public VentanaConsultaCliente() {
        ...
        Object titulos[] = {"ID del Cliente", "Nombre del Cliente","Calle del Cliente","Numero del Cliente","Colonia del Cliente"
            ,"Codigo Postal del Cliente","Municipio del Cliente","Estado del Cliente", "Telefono Celular del Cliente"
            ,"Telefono del Cliente","Fecha de Registro del Cliente"};
