 ...
 * @author Joako0z
 */
public class VentanaModifcarCliente extends javax.swing.JInternalFrame {
...
///
        String fecha = new SimpleDateFormat("yyyy-MM-dd").format(this.jDateChooser2.getDate());
        
         query = "update cliente set "
                + "nomCliente='" + this.jTextField1.getText()
                + "', calleCliente='" + this.jTextField2.getText()
                + "', numCliente='" + this.jTextField3.getText()
                + "', colCliente='" + this.idcolonia
                + "', cpCliente='" + this.jTextField4.getText()
                + "', munCliente='" + this.idmunicipio
                + "', estadoCliente='" + this.idestado
                + "', telcelCliente='" + this.jTextField6.getText()
                + "', telCliente='" + this.jTextField5.getText()
                + "', fecregCliente='" + fecha + "' where idCliente="+this.jTextField7.getText();
         System.out.println("QUERY: "+query);
        objConn.Update(query);

        JOptionPane.showMessageDialog(this, "Cliente modificado exitosamente", "Mensaje", 1);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        String query = "Select * from cliente where idCliente="+this.jTextField7.getText();
        ...
        if(datos.length>0){
            ...
            this.jDateChooser2.setDateFormatString((String)datos[0][10]);
        }
        else{
